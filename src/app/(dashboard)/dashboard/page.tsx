      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-8 bg-gray-800/60 border-gray-700">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            ...
            <Link
              href="/profile"
              className="px-4 py-2 bg-gray-700/50 hover:bg-gray-600/50 border border-gray-600 rounded-lg text-gray-300 text-sm transition-colors flex items-center gap-1.5 flex-shrink-0"
            >
