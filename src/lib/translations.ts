...
export const translations: Record<Lang, Translation> = {
  en: {
    ...
    emailWillVerify: "We'll send a verification code to your inbox",
  ...
  ja: {
    ...
    previous: '前へ',
    next: '次へ',
    enterVerificationCode: '6桁のコードを入力',
    verificationCode: '確認コード',
    verifyEmail: 'メールを確認',
    codeSentTo: '確認コードを送信しました',
    didNotReceiveCode: 'コードが届かない場合',
    resendCode: '再送',
    codeExpired: 'コードが期限切れです。再送してください',
    invalidCode: '確認コードが無効です',
    verificationSuccess: 'メール確認成功！',
    registerSuccess: '登録成功！',
    backToRegister: '登録に戻る',
    verifying: '確認中...',
    sendCode: '確認コードを送信',
    enterEmail: 'メールアドレスを入力',
    emailWillVerify: '確認コードをメールでお送りします',
    checkInbox: '受信トレイを確認',
    noCode: '届かない場合？',
    changeEmail: 'メールを変更',
  ...
  ko: {
    ...
    previous: '이전',
    next: '다음',
    enterVerificationCode: '6자리 코드 입력',
    verificationCode: '인증 코드',
    verifyEmail: '이메일 확인',
    codeSentTo: '인증 코드를 전송했습니다',
    didNotReceiveCode: '코드를 받지 못했습니다',
    resendCode: '재발송',
    codeExpired: '코드가 만료되었습니다. 재발송해주세요',
    invalidCode: '인증 코드가 올바르지 않습니다',
    verificationSuccess: '이메일 확인 성공!',
    registerSuccess: '회원가입 성공!',
    backToRegister: '회원가입으로 돌아가기',
    verifying: '확인 중...',
    sendCode: '인증 코드 보내기',
    enterEmail: '이메일 입력',
    emailWillVerify: '인증 코드를 이메일로 보내드립니다',
    checkInbox: '수신함 확인',
    noCode: '못 받으셨나요?',
    changeEmail: '이메일 변경',
    ...
    almostDone: '거의 완료!',
    emailVerified: '이메일 확인 완료!',
    backToVerify: '확인으로 돌아가기',
    invalidEmail: '유효한 이메일을 입력하세요',
    enter6Digit: '6자리 코드를 입력하세요',
  ...
  es: {
    ...
    backToVerify: 'Volver a verificación',
    invalidEmail: 'Ingresa un email válido',
    enter6Digit: 'Ingresa el código de 6 dígitos',
  ...
  fr: {
    ...
    resendCode: 'Renvoyer',
    codeExpired: 'Code expiré. Veuillez renvoyer.',
    ...
    emailWillVerify: 'Nous vous enverrons un code de vérification',
  ...
  de: {
    ...
    codeExpired: 'Code abgelaufen. Bitte erneut senden.',
